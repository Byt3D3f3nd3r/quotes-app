from flask import Flask, render_template  # type: ignore # Import Flask and template rendering
...
def get_random_quote():
    ...
    with open('/mnt/data/quotes.txt', 'r') as file:
...
if __name__ == '__main__':
    app.run(debug=True)  # Run the app in debug mode so we can see errors if they happen
